'''
Crear scv para los modelos de machine learning
------------------------------------------------
...
# los datos y recién ahí escalarlos, por lo que aquí se hará ese proceso y se guardará en un csv llamado 
# "clasificar_recetas.csv" para luego usarlo en el entrenamiento del modelo.
